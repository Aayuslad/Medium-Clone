...
exports.editReplySchema = exports.editResponseSchema = exports.makeReplyToResponseSchema = exports.makeResponseSchema = exports.followTopicSchema = exports.clapStorySchema = exports.updateStorySchema = exports.createStorySchema = exports.followUserSchema = exports.updateUserAboutSectionSchema = exports.updateUserSchema = exports.signinUserSchema = exports.signUpUserSchema = void 0;
...
//
exports.makeResponseSchema = zod_1.default.object({
    content: zod_1.default.string().max(500),
    storyId: zod_1.default.string(),
});
//
exports.makeReplyToResponseSchema = zod_1.default.object({
    content: zod_1.default.string(),
    responseId: zod_1.default.string(),
});
//
exports.editResponseSchema = zod_1.default.object({
    responseId: zod_1.default.string(),
    content: zod_1.default.string(),
});
//
exports.editReplySchema = zod_1.default.object({
    responseId: zod_1.default.string(),
    content: zod_1.default.string(),
});
